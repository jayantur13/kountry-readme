...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Kountry - NPM Module</title>
        <meta name="description" content="This the Kountry library/npm module website available in node and yarn package managers" />
      ...
      <main className={styles.main}>
        ...
        <div>
          <h2>Kountry &rarr;</h2>
          <p>Npm module variant of the <a href='https://github.com/jayantur13/GraphQL-Country-API'>Country-API</a></p>
          ...
          <p className={styles.code}>
            ...
            <br />
            <br />
            <a className='link' href='https://www.npmjs.com/package/kountry'>npm</a> install kountry
            <br />
            <br />
            <br />
            ...
            <br />
            <br />
            <a className='link' href='https://yarnpkg.com/package/kountry'>yarn</a> add kountry
          </p>
