...
export default function Examples() {
  return (
    <>
      <Head>
        <title>Kountry Node Module - Examples</title>
        <meta charSet="utf-8" />
        <meta
          name="description"
          content="Some examples for the people to try in this country npm package"
        />
        <meta
          name="keywords"
      ...
      <main className={styles.main}>
        <h1 className={styles.title}>Some Examples</h1>

        <p className={styles.description}>
          <span className={styles.fingerdown}>👇</span>Checkout
        ...
        <div>
          ...
          <p>
            byName(countryName)<a href="#bname">🔗</a>
          </p>
          <p>
            byCountryCode(countryCode)<a href="#bcc">🔗</a>
          </p>
          <p>
            byId(id) <a href="#bid">🔗</a>
          </p>
          <p>
            byIsoCode(isoCode)<a href="#bic">🔗</a>
          </p>
          <p>
            byPopulation(sort,limit)<a href="#bp">🔗</a>
          </p>
          <p>
            byGdp(sort,limit) <a href="#bg">🔗</a>
          </p>
          <p>
            doAlphabetically(sort,limit)<a href="#bda">🔗</a>
          </p>
          ...
          <p>
            @param CountryCode [Number/String] takes a valid number/string that
            exists
          </p>
          <p className={styles.code}>
            const kountry = require(&apos;kountry&apos;)
          ...
          <p>
            @param sort [String] takes either &apos;asc&apos; or
            &apos;desc&apos; for ordering
            <br />
          ...
          <p>
            ...
            &apos;desc&apos; for ordering
            <br />
            @param limit [Number] Number must be between {">="} 4 and {"<"} MAX
            ie total length
          </p>
          <p className={styles.code}>
            const kountry = require(&apos;kountry&apos;)
            ...
            <br />
            const country =
            kountry.byPopulation(sort=&apos;asc&apos;,limit=kountry.MAX)
            <br />
            <br />
            {`//`}Descending order limit MAX i.e total length
            <br />
            const country =
            kountry.byPopulation(sort=&apos;desc&apos;,limit=kountry.MAX)
            <br />
            <br />
            {`//`}Ascending order limit 8<br />
            const country = kountry.byPopulation(sort=&apos;asc&apos;,limit=8)
